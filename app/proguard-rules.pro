...
# gl_presentation_callback.cpp resolves these callbacks by name/signature through JNI.
# Their only caller is native code, so R8 cannot infer that the methods are live.
-keepclassmembers class ml.melun.mangaview.viewer.runtime.OwnedRendererCallback {
    ...
    public void onCompletionPending();
}
