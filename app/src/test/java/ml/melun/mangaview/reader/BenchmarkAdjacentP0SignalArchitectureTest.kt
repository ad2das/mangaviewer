...
class BenchmarkAdjacentP0SignalArchitectureTest {
    ...
    fun releaseUsesNoOpWhileBenchmarkRetainsExactPerSourceFiltering() {
        ...
        assertTrue(benchmarkSignalSource.contains("PREPARED_RUNWAY_PAGES = 5"))
        assertTrue(benchmarkSignalSource.contains("RunwayReadyState ready = runwayReadyState"))
        assertTrue(benchmarkSignalSource.contains("EXTRA_RUNWAY_READY_AT_NANOS, ready.readyAtNanos"))
