...
public class EpisodeActivityTest {
    ...
    public void ntkDirectWarmupIsDisabledOnEpisodeList() {
        assertFalse(EpisodeActivity.shouldDirectWarmupNtkViewerPageForTest(true, false, "/manhwa/1/episode"));
        assertFalse(EpisodeActivity.shouldDirectWarmupNtkViewerPageForTest(false, true, "/webtoon/1/episode"));
