...
public abstract class TaskRunner<Params, Progress, Result> implements DefaultLifecycleObserver {
    public enum Status {
        PENDING,
        RUNNING,
        FINISHED
    ...
    protected TaskRunner(Object lifecycleCandidate) {
    ...
    public final TaskRunner<Params, Progress, Result> start(Params... params) {
        return startOnExecutor(THREAD_POOL_EXECUTOR, params);
    }

    public final TaskRunner<Params, Progress, Result> startOnExecutor(Executor executor, Params... params) {
