    ...
    private static String normalizeViewerImageApiSrc(String src, String kind, String workId,
        ...
        if(pageFile && safeWorkId.length() > 0 && safeEpisodeId.length() > 0) {
            if("webtoon".equals(safeKind))
                return "https://flysky3m.com/blacktoon/episodes/" + safeWorkId + "/" + safeEpisodeId + "/" + value;
            return "https://flysky3m.com/manhwa/" + safeWorkId + "/" + safeEpisodeId + "/" + value;
        }
        if(value.startsWith("//"))
            value = "https:" + value;
        if(value.startsWith("/")) {
            if(lower.startsWith("/manhwa/") || lower.startsWith("/blacktoon/episodes/")
                ...
                value = "https://flysky3m.com" + value;
            else
                return "";
        }
