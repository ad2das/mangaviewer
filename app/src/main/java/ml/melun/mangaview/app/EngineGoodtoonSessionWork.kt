...
internal class EngineGoodtoonSessionWork(
    userAgent: String,
    ...
    private val principal = "goodtoon:public"
    private val planner = GoodtoonAccessPlanner(userAgent)
    private val catalogPlanner = GoodtoonEpisodeCatalogPlanner(userAgent)
    ...
    private val pages = EnginePageWork(principal, planner, transport, storage) { _, _, _ ->
        error("GOODTOON returned an unsupported access prerequisite")
    }
